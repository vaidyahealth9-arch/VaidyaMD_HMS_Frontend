              ...
              <div className="space-y-1.5">
                ...
                <div className="flex flex-col gap-1.5 items-start">
                  ...
                  <button
                    ...
                    className="inline-flex items-center gap-1 px-2.5 py-1 bg-indigo-50 border border-indigo-200 hover:bg-indigo-100 text-indigo-700 rounded text-[11px] font-bold transition-colors shadow-2xs cursor-pointer"
                  >
