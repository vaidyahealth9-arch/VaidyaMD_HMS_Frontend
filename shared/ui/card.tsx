...
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn(
      'rounded-lg border bg-white text-[rgb(var(--clr-text))] transition-shadow',
      className
    )}
    style={{ borderColor: 'rgb(var(--clr-border))', boxShadow: 'var(--shadow-card)' }}
    {...props}
  />
));
