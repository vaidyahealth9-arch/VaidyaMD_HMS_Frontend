...
import { AmbientScribeProvider } from '@/contexts/AmbientScribeContext';
...
export default function AppShell({ children }: { children: ReactNode }) {
  ...
  if (isLoading) {
    return (
      <div className="h-screen flex items-center justify-center bg-rail-bg">
        <div className="flex flex-col items-center gap-4">
          ...
          <div className="text-center">
            <p className="text-sm font-semibold tracking-wide text-white/90">
              Vaidya<span className="text-accent">MD</span> HMS
            </p>
  ...
  return (
    <NotificationProvider userId={user.id}>
      <SidebarProvider>
        <AmbientScribeProvider>
          <div className="h-screen flex overflow-hidden bg-surface-muted">
            ...
            <div className="flex-1 flex flex-col min-w-0 overflow-hidden">
              ...
              <div className="flex-1 flex overflow-hidden">
                ...
                {/* Main Content */}
                <main className="flex-1 overflow-y-auto relative bg-surface-muted">
